...
package Alice.App is
   ...
   --
   --  #FIXME - What if an actual Use Case needs additional parameters? Makes
   --  sense to derive from the Use_Case interface and add the parameters to
   --  the Run function? Or should we use a different approach, like a
