...
package body GitHub.Profile is
   ...
   begin
      ...
      if Read_Result.Value.Has (Key_Name) then
         ...
         Profile.User_Name := Null_Unbounded_String;
         Log.Debug ("Read_Result (Name) : not found");
      end if;
      ...
      if Read_Result.Value.Has (Key_Email) then
         ...
         Profile.User_Email := To_Unbounded_String ("");
         Log.Debug ("Read_Result (Email) : not found");
      end if;
      ...
      if Read_Result.Value.Has (Key_SPDX_Id) then
         ...
         Profile.SPDX_Id := Null_Unbounded_String;
         Log.Debug ("Read_Result (SPDX_Id) : not found");
      end if;
